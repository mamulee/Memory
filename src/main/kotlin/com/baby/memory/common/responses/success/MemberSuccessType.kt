...
enum class MemberSuccessType(
    ...
    SIGN_UP(
        "MS001", HttpStatus.CREATED, "Memory 회원이 되신 것을 축하합니다!"
    ),
    SIGN_IN(
        "MS002", HttpStatus.OK, "로그인 성공!"
    ),
    SIGN_OUT(
        "MS003", HttpStatus.OK, "로그아웃 성공!"
    ),
    UPDATE_MEMBER_NAME(
        "MS004", HttpStatus.OK, "닉네임 변경 성공!"
    ),
    ...
    FOLLOWING(
    "MS007", HttpStatus.OK, "팔로우 / 팔로우 취소 성공!"
    ),
    UNFOLLOW(
